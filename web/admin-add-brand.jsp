    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav" style="display: flex; background-color: #eee;">
            ...
            <div style=" margin: 296px 0 296px; background-color: white; padding: 30px 50px 6px;border-radius: 30px; width: 15%; text-align: center" >
                <form action="admin-add-brand" id="add-form" method="POST">
                    <div>
                        <label style="font-weight: bold">Brand Name: </label> <br/>
                        <input style="width:100%; margin: 20px 0 20px; padding: 3px " required  name="brand_name" type="text" id="product-name">
