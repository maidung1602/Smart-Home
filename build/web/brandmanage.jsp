                                ...
                                <div class="row" style="padding-top: 20px">
                                    <c:forEach items="${brands}" var="b">
                                        <div class="cate">
                                            <h5>${b.brand_name}</h5>
                                            <div>
                                                <button onclick="window.location.href='admin-edit-brand?id='+${b.id}" type="button" class="btn" style="background-color: #0abbcb; color: white;">Edit</button>
                                                <button type="button" onclick="doDelete('${b.id}')" class="btn" style="background-color: #0abbcbcb; color: white;">Delete</button>
                                            </div>
                                        </div>
                                    </c:forEach>
                                </div>
