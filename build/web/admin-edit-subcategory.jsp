    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav" style="display: flex; background-color: #eee;">
            ...
            <div style=" margin: 296px 0 296px; background-color: white; padding: 30px 50px 6px;border-radius: 30px; width: 15%; text-align: center" >
                <form action="admin-edit-subcategory" id="add-form" method="POST">
                    ...
                    <div>
                        ...
                        <input style="width:100%; margin: 20px 0 20px; padding: 3px " value="${subcategory.subcategory_name}" required name="subcategory_name" type="text" id="product-name">
                        <button type="submit" class="btn" style="background-color: #0abbcb; color: white;">Save</button>
                    </div>
                </form>
            </div>
        </div>     
